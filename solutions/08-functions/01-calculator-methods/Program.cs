// Exercise 08-01: Calculator Methods - Reference Solution
...
// Create input validation method
...
static void Main(string[] args)
{
    ...
    {
        // Get numbers and operation using your methods
        ...
        switch (operation)
        {
            ...
            case "/":
                ...
                if (num2 != 0) // Only display if division was successful
                {
                    DisplayResult(num1, operation, num2, result);
                }
                break;
