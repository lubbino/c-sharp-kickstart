// Exercise 08-02: Utility Methods - Reference Solution
...
{
    // Create a method 'IsEven' that takes an integer and returns true if it's even
    public static bool IsEven(int number)
    {
        return number % 2 == 0;
    }

    // Create a method 'GetMax' that takes two integers and returns the larger one
    public static int GetMax(int a, int b)
    {
        return a > b ? a : b;
    }

    // Create a method 'ReverseString' that takes a string and returns it reversed
    ...
    // Create a method 'CountVowels' that counts vowels in a string
    ...
    // Create a method 'IsPrime' that checks if a number is prime
